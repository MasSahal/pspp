                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('/petugas/datasiswa/' . $s['nisn'] . '/delete') ?>" onclick="return confirm('Yakin hapus data tahun <?= $s['nis'] ?>?')" class="btn btn-danger ml-3"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
        ...
        <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?= base_url('/petugas/insert_siswa') ?>">
