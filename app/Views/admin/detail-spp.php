...
<div class="row">
    <div class="col">
        <div class="card shadow border-left-success mb-3">
            ...
            <div class="card-body">
                <form action="<?= base_url('admin/entri-spp/bayar-spp') ?>" method="post">
                    <table class="table table-sm table-borderless">
                        <tr>
                            <td>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($data_spp as $d) {; ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('admin/print/' . $siswa->nisn . "/" . $d->id_pembayaran) ?>" class="btn btn-default btn-outline-dark rounded-0 btn-sm" target="_blank"><i class="fa fa-print" aria-hidden="true"></i> Cetak</a>
                                </td>
                            </tr>
                        <?php }; ?>
                    </tbody>
